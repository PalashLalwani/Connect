...
{  
    if($_FILES['pic']['type']=="image/png" || $_FILES['pic']['type']=="image/jpg" || $_FILES['pic']['type']=="image/jpeg")
    {
        ...
        $actual_path = "http://localhost/connect/uploads/".$target_user_file."/".$_FILES['pic']['name'];
        
        $up = "uploads/".$_FILES['pic']['name'];

       /*move_uploaded_file($_FILES['pic']['tmp_name'],"D:/xampp/htdocs/connect/{$_FILES['pic']['name']}");*/
