			...
			<div class="site-wrapper-inner">
				...
				<div class="cover-container">
					...
					<div class="masthead clearfix">
						<div class="inner">
							<h3 class="masthead-brand"><a href="index" style="color: #ffffff;">Connect</a></h3>
							<nav>
					...
					<div class="inner cover bar a" id="signup" style="font-size: larger;">
						<div id="success"></div>
					...
					<div class="inner cover bar a" id="login" style="font-size: larger">
						<br>
						...
						<form class="form-horizontal" method="post" id="login_form">
							...
							<div class="form-group">
				                ...
				                <a href="forget.html" class="forget" id="forgotlink">forgot password</a>
								</div>
					...
					<div class="inner cover bar a" id="about" style="font-size: larger">
						<br>
						<h1 class="cover-heading">About CampusConnect</h1>
						<h3>Tired of using FB?</h3>
						<p class="text-primary">We are Student of SGSITS Indore persuing Information Technology Engineering and this is our third year project.
							<h2>We wish you will love it!!!!</h2>
					...
					<!--<div class="inner cover bar a" id="forgot" style="font-size: larger">
						<br>
						<h1 class="cover-heading">Forgot Password!!! Don't Worry</h1>
					...
					<div class="mastfoot">
						<div class="inner">
							<p>Made with lots of efforts<img src="img/love.png" width="9%"> by team. <a href="#" target="#">@Connect</a>.</p>
						</div>
					</div>
