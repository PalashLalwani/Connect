...
<html lang="en">
  ...
  var modal = $(this);
  modal.find('.modal-body').load('http://localhost/connect/php/photo.php?id=<?php echo $user_id; ?>');
});
        </script>
        ...
        //important
         ...
         if(in_array($other_id,$_SESSION['block_list']))
                    {   //if id is in the block list
                        ?>
                            <script>
                                window.location.href="http://localhost/connect/profile";
                            </script>
        ...
        <script>
            ...
            $('#acceptRequest').click(function(){
                ...
                <script>
                            ...
                            var modal = $(this);
                            modal.find('.modal-body').load("http://localhost/connect/php/photo.php?id=<?php echo $other_id;?>");
                            });
                            
                            $('<?php echo '#'.$other_id."common"; ?>').on('show.bs.modal', function (event) {
                            var modal = $(this);
                            modal.find('.modal-body').load("http://localhost/connect/common.php?other_id=<?php echo $other_id;?>");
                            });
                </script>
 ...
 <script>
  ...
  var modal = $(this);
  modal.find('.modal-body').load('http://localhost/connect/edit.php');
});
   $('#changephoto').on('show.bs.modal', function (event) {
  var modal = $(this);
  modal.find('.modal-body').load('http://localhost/connect/changephoto.php');
});  
